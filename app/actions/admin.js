...
export async function importOldSmkData() {
  try {
      ...
      if (oldSchool) {
        await prisma.school.upsert({
          ...
          update: {
            ...
            heroTitle: oldSchool.heroTitle || "Membentuk Generasi Unggul Berakhlak, Terampil & Siap Kerja",
          ...
          create: {
            ...
            nama: "SMP & SMK AL QODIRIYAH WINDUSARI (TERPADU)",
            npsn: oldSchool.npsn || "69901347",
            alamat: oldSchool.alamat || "Jegedeh Wahyurejo, Candisari, Windusari, Magelang",
            heroTitle: oldSchool.heroTitle || "Membentuk Generasi Unggul Berakhlak, Terampil & Siap Kerja",
            heroSubtitle: oldSchool.heroSubtitle || "SMP & Sekolah Master Demo memadukan keunggulan akademis & keahlian DKV dengan pembinaan akhlak mulia berkarakter Islami.",
            sambutanTitle: oldSchool.sambutanTitle || "Selamat Datang di SMP & Sekolah Master Demo",
            sejarahTitle: oldSchool.sejarahTitle || "Perjalanan SMP & Sekolah Master Demo",
    ...
    await prisma.school.upsert({
      ...
      update: {
        nama: "SMP & SMK AL QODIRIYAH WINDUSARI (TERPADU)",
        heroTitle: "Membentuk Generasi Unggul Berakhlak, Terampil & Siap Kerja",
        ...
        sejarahText: `SMP & Sekolah Master Demo didirikan di bawah naungan Yayasan Edukasi Master untuk menyediakan sarana pendidikan tingkat menengah SMP dan SMK kejuruan (Desain Komunikasi Visual) yang berkualitas, terjangkau, dan sarat akan pembinaan moral keagamaan bagi masyarakat di lereng Gunung Sumbing, Windusari, Magelang.\n\nDengan komitmen pengembangan berkelanjutan, unit SMK menghadirkan Program Keahlian Desain Komunikasi Visual (DKV) untuk mencetak lulusan yang terampil secara teknis, berjiwa wirausaha, serta berakhlak mulia.`,
