...
export default async function CetakSKNR({ params }) {
  ...
  const qrUrl = `https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=${encodeURIComponent(`${domain}/verifikasi?nisn=${nisn}&doc=sknr`)}`;
      ...
      <body>
        <div className="a4-page">
          ...
          <p style={{ fontSize: "11pt", textAlign: "justify", lineHeight: "1.5" }}>
            Yang bertanda tangan di bawah ini, Kepala {school?.nama || "Sekolah Master Demo"}, menerangkan bahwa:
          </p>
          ...
          <p style={{ fontSize: "11pt", textAlign: "justify", lineHeight: "1.5" }}>
            Adalah benar siswa tersebut di atas telah menyelesaikan seluruh program pembelajaran di {school?.nama || "Sekolah Master Demo"} dari Semester 1 hingga Semester 6, dan dokumen Transkrip Nilai (terlampir) adalah benar dan sah sesuai dengan data Buku Induk Siswa.
          </p>
          
          <p style={{ fontSize: "11pt", textAlign: "justify", lineHeight: "1.5", marginTop: "1rem" }}>
            Surat Keterangan Nilai Rapor (SKNR) ini diterbitkan sebagai pengganti sementara SKHUN/Ijazah asli yang masih dalam proses pencetakan oleh Dinas Pendidikan, dan dapat digunakan untuk keperluan pendaftaran Perguruan Tinggi maupun melamar pekerjaan.
          </p>
